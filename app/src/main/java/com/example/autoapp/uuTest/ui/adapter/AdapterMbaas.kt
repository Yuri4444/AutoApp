package com.example.autoapp.uuTest.ui.adapter
...
class AdapterMbaas(private val context: Context) : RecyclerView.Adapter<AdapterMbaas.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AdapterMbaas.ViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val binding = ItemAutoBinding.inflate(layoutInflater, parent, false)
        return ViewHolder(binding)
    }

    override fun onBindViewHolder(holder: AdapterMbaas.ViewHolder, position: Int) {
